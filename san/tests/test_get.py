...
def test_prices(mock, test_response):
    api_call_result = {
        "query_0": [
            ...
            {"priceUsd": "1.2551352777777771", "priceBtc": "0.00016521851041666669", "datetime": "2018-06-02T00:00:00Z"},
            {"priceUsd": "1.251881943462897", "priceBtc": "0.000162902558303887", "datetime": "2018-06-03T00:00:00Z"},
            ...
            "ethTopTransactions": [
                {
                    ...
                    "fromAddress": {"address": "0x1f3df0b8390bb8e9e322972c5e75583e87608ec2", "isExchange": False},
                    "toAddress": {"address": "0xd69bc0585e05ea381ce3ae69626ce4e8a0629e16", "isExchange": False},
                ...
                },
                {
                    ...
                    "fromAddress": {"address": "0x1f3df0b8390bb8e9e322972c5e75583e87608ec2", "isExchange": False},
                    "toAddress": {"address": "0x723fb5c14eaff826b386052aace3b9b21999bf50", "isExchange": False},
...
def test_batch_only_with_transform_queries(mock, test_response):
            ...
            "ethTopTransactions": [
                {
                    ...
                    "fromAddress": {"address": "0xe76fe52a251c8f3a5dcd657e47a6c8d16fdf4bfa", "isExchange": False},
                    "toAddress": {"address": "0x45d6275d9496bc61b5b072a75089be4c5ab54068", "isExchange": False},
                ...
                },
                {
                    ...
                    "fromAddress": {"address": "0xe76fe52a251c8f3a5dcd657e47a6c8d16fdf4bfa", "isExchange": False},
                    "toAddress": {"address": "0x468bdccdc334f646f1acfb4f69e3e855d23440e2", "isExchange": False},
    ...
    batch.get("eth_top_transactions/santiment", from_date="2019-04-18", to_date="2019-04-22", limit=5, transaction_type="ALL")

    batch.get("eth_top_transactions/santiment", from_date="2019-04-23", to_date="2019-04-29", limit=5, transaction_type="ALL")
...
def test_transform_arg_transform_given():
    ...
    assert san.sanbase_graphql._transform_arg_helper(kwargs) == 'transform:{type: "moving_average"\nmoving_average_base: 100\n}'
